...
public class linkUnion_02 implements Initializable{
	...
	private AnchorPane exp;
	 ...
	 public void eventNav3() throws IOException {
	    	...
	    	FXMLLoader loader = new FXMLLoader(getClass().getResource("../linkUnion/link_03.fxml"));
	        Parent root = loader.load();
	        Scene scene = new Scene(root);
	    	stage.setScene(scene);
	    }
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			...
			for(int i = 0; i < tableNum.get(1)/2; i++) {
				...
				myTableView.getItems().add(new linkVO(
					new SimpleStringProperty(((ArrayList<String>) jobMap.get(category.get(1))).get(i)), 
					new SimpleStringProperty(((ArrayList<String>) skillMap.get(category.get(1))).get(i)), 
					new SimpleStringProperty(((ArrayList<String>) effectMap.get(category.get(1))).get(i)))
					);
			}
